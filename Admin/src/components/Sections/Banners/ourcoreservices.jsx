...
const OurCoreServices = () => {
    ...
    const handleEdit = (banner) => {
        ...
        navigate("/editbanner", { state: { banner, apiEndpoint: 'our-core-services' } });
      };
      ...
      const handleDelete = async (id) => {
        ...
        try {
          const response = await fetch(`http://13.126.118.3:3000/v1.0/admin/our-core-services/${id}`, {
            method: "DELETE",
          });
    
          if (response.ok) {
            alert("Deleted successfully");
            setcoreservices((prevData) => prevData.filter((banner) => banner._id !== id));
          } else {
        ...
        <>
            ...
            {Array.isArray(coreservices) && coreservices.map((banner) => (
               ...
               <div className="edit-button" onClick={() => handleEdit(banner)}>
                ...
                <div className="delete-button" onClick={() => handleDelete(banner._id)}>
